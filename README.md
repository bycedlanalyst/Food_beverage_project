...
## 🎨 Gallerie des Dashboards

### Dashboard Marketing ROI - Vue détaillée

![Marketing ROI Overview](Images/Marketin_Dash1.png)

**Caractéristiques principales :**
- 5 KPI cards (Campagnes, Budget, CA, Conversion, ROI)
- Graphiques comparatifs : ROI vs Budget-CA
- Distribution par audience (pie chart)
- Top 10 campagnes avec drill-down
- Courbe d'évolution du ROI mensuel

---

### Dashboard Promotion Analysis - Vue détaillée

![Promotion Analysis Overview](Images/Promotion_Dash1.png)

**Caractéristiques principales :**
- 5 KPI cards (Promos, Remise moy, CA, Panier, Transactions)
- Performance par catégorie produit
- Distribution par région
- Top 10 promotions
- Impact du taux de remise (2 charts)

---

### Dashboard Sales - Vue détaillée

![Sales Dashboard Overview](Images/Sales_Dash1.png)

**Caractéristiques principales :**
- 4 KPI cards (Transactions, CA, Panier moyen, Régions)
- Courbe d'évolution mensuelle du CA
- Performance régionale (bar + pie)
- Impact des promotions (2 charts)
- Top 10 entités par CA
